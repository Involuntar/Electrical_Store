...
| Менеджер                                     | **POST** | `/api/product`      | product_name  | str, минимальная длинна - 2 символа                    |
|                                              |          |                     | product_price | float, ≥ 0                                             |
|                                              |          |                     | description   | str, optional                                          |
|                                              |          |                     | category_id   | int                                                    |
|                                              |          |                     | amount        | int, ≥ 0                                               |
| Менеджер                                     | **PUT**  | `/api/product/{id}` | id            | int                                                    |
|                                              |          |                     | product_name  | str, минимальная длинна - 2 символа                    |
|                                              |          |                     | product_price | float, > 0                                             |
|                                              |          |                     | description   | str, optional                                          |
|                                              |          |                     | category_id   | int                                                    |
|                                              |          |                     | amount        | int, ≥ 0                                               |
| Пользователь/Менеджер/Админ                  | **POST** | `/api/order`        | summ          | float, > 0                                             |
|                                              |          |                     | order_date    | date                                                   |
|                                              |          |                     | user_id       | int                                                    |
|                                              |          |                     | status_id     | int                                                    |
